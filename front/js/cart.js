...
if (produitLocalStorage === null || produitLocalStorage == 0) {
    ...
    positionEmptyCart.textContent = emptyCart;
} else {
for (let produit in produitLocalStorage){
    ...
    productTitle.textContent = produitLocalStorage[produit].nomProduit;

    // Insertion de la couleur
    let productColor = document.createElement("p");
    productTitle.appendChild(productColor);
    productColor.textContent = produitLocalStorage[produit].couleurProduit;
    productColor.style.fontSize = "20px";

    // Insertion du prix
    let productPrice = document.createElement("p");
    productItemContentTitlePrice.appendChild(productPrice);
    productPrice.textContent = produitLocalStorage[produit].prixProduit + " €";
